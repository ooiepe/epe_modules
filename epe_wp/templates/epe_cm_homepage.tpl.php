  ...
  <div class="span7">
    <div class="resource_option lib clearfix">
      <div class="icon_thumb">        
        <a href="<?php echo base_path(); ?>resource-browser#/search?type=cm&page=1&filter=featured">
        <img src="<?php echo drupal_get_path('theme','epe_theme'); ?>/images/about-investigation-icon.jpg" alt="Icon of Investigation Library">
        </a>
      </div>
      <div class="info">
        <div class="option_title"><a href="<?php echo base_path(); ?>resource-browser#/search?type=cm&page=1&filter=featured">Investigation Library</a></div>
    ...
    <div class="resource_option copy_mod clearfix">
      <div class="icon_thumb">
        <a href="<?php echo base_path(); ?>resource-browser#/search?type=cm&page=1">
        <img src="<?php echo drupal_get_path('theme','epe_theme'); ?>/images/about-copy-modify-icon.jpg" alt="Icon of Copy and Modify">
        </a>
      </div>
      <div class="info">
        <div class="option_title"><a href="<?php echo base_path(); ?>resource-browser#/search?type=cm&page=1">Copy and Modify</a></div>
    ...
    <div class="resource_option create clearfix">
      <div class="icon_thumb">
        <a href="<?php echo base_path(); ?>node/add/cm-resource">
        <img src="<?php echo drupal_get_path('theme','epe_theme'); ?>/images/about-create-icon.jpg" alt="Icon of Create your Own">
        </a>
      </div>
      <div class="info">
        <div class="option_title"><a href="<?php echo base_path(); ?>node/add/cm-resource">Create your Own</a></div>
