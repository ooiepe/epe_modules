...
function loadFlash() {
  ...
  swfobject.embedSWF('<?php echo base_path() . drupal_get_path('module', 'epe_cm') ?>/swf/CMV_15_20150415_1232.swf', 'flashcontent', '100%', '400', '9', 'expressInstall.swf', flashvars, params, attributes);
