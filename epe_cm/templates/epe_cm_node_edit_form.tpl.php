...
function loadFlash() {
  ...
  swfobject.embedSWF('<?php echo base_path() . drupal_get_path('module', 'epe_cm') ?>/swf/CMV_15_20140917_1008.swf', 'flashcontent', '100%', '700', '9', 'expressInstall.swf', flashvars, params, attributes);
        ...
        buttons: {
          main: {
            ...
            callback: function(event) {
              ...
              jQuery.session.set('selectedResources',JSON.stringify(selected));
            /*var selected = [];
