define(['angularAMD','angularRoute','angularWebstorage','ngProgress','underscore','bw.paging'], function(angularAMD) {
  var app = angular.module("app", ['ngRoute','underscore','webStorageModule','ngProgress','bw.paging']);
